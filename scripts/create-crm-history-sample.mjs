...
const rows = [
  ['华东业务部', '周岚', '2026-05-10', '2026-06-15', 33, '星河园区节能改造项目', 'CRM-001', '跟进中', '71%-80%', 860, '2026-08-20'],
  ['华南业务部', '韩哲', '2026-03-02', '2026-04-01', 108, '云港仓储升级项目', 'CRM-002', '呆滞', '1%-50%', 1200, '2026-09-30'],
  ['华北业务部', '叶宁', '2026-01-18', '2026-06-28', 20, '远景水务数字化项目', 'CRM-003', '呆滞', '询价类', 680, '2026-06-30'],
  ['华中业务部', '许安', '2026-06-03', '2026-07-10', 8, '无', '无', '跟进中', '81%-100%', 320, '2026-08-15'],
  ['华东业务部', '周岚', '2026-04-26', '2026-07-05', 3, '北辰综合管廊项目', 'CRM-005', '跟进中', '1%-50%', 1850, '2026-11-10'],
  ['华西业务部', '宋敏', '2026-06-20', '2026-07-16', 2, '清源厂区运维项目', 'CRM-006', '跟进中', '81%-100%', 240, '2026-08-05']
];
